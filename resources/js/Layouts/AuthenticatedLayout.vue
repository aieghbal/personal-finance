            ...
            <nav class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    <div class="space-y-1 pb-3 pt-2">
                        <ResponsiveNavLink :href="route('dashboard')" :active="route().current('dashboard')"> داشبورد </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('accounts.index')" :active="route().current('accounts.index')"> حساب‌ها </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('categories.index')" :active="route().current('categories.index')"> دسته‌بندی‌ها </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('transactions.index')" :active="route().current('transactions.index')"> تراکنش‌ها </ResponsiveNavLink>
                    </div>
                    ...
                    <div class="border-t border-gray-200 pb-1 pt-4 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('logout')" method="post" as="button"> خروج </ResponsiveNavLink>
                        </div>
                    </div>
                </div>
            </nav>
